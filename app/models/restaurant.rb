class Restaurant
	...
	def initialize(args)	
		...
		@user_search_params = args[:user_search_params]
		@user_locale = args[:user_locale]
	end

	def fetch_restaurant_information_from_yelp_api
		Yelp.client.search(@user_city,@user_search_params,@user_locale)
	end
